...
earlyStopping = EarlyStopping(monitor='val_loss', mode = 'min',patience=300, restore_best_weights=True, verbose = 1)

hist = model.fit(x_train,y_train, epochs=1000, batch_size=3
          ,validation_split= 0.2, 
          verbose = 1, callbacks=[earlyStopping]
          )
# batch 7/ loss :  2195.711669921875 <6<5<4
# 3  loss :  1823.588623046875
#4. evaluate,predict
